...
plot(1940:2020,dat[,1],type="l",xlab="Year",ylab="Death rates and µ values",cex.lab=1.5,cex.axis=1.5) 
lines(1940:2020,dat[,2],col="grey")
legend("topright",c("Observed death rates","µ"),pch="_",col = c("black","grey"),cex=1.5)
